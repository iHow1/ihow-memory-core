...
**Alpha.27 checkpoint core 状态：** library 已具备有界可变 draft、不可变 hash-addressed checkpoint artifact、fail-closed 治理，以及 read/list/inspect API。当前只完成 storage/core；尚未接入 Claude/Codex hook、PreCompact、`continue` 或用户侧 checkpoint 流程。
