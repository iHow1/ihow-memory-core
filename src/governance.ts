...
// credential-bearing service URI and the body of a Bearer/JWT token; redacting that tail would erase the very
...
// `pass@host.tld` tail of a URL-embedded credential or a Bearer/JWT body to [redacted],
