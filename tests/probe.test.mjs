...
test('verifyConnection: a no-CLI runtime with a working server is pending, not falsely reachable', async (t) => {
  ...
  assert.equal(v.reachable, false, 'no install-time round-trip from the runtime side');
